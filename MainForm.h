...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			this->hm_data_grid->Location = System::Drawing::Point(0, 0);
			...
			this->hm_data_grid->Size = System::Drawing::Size(911, 550);
